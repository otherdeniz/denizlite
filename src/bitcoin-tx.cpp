...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s denizlite-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  denizlite-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded denizlite transaction") + "\n" +
              "  denizlite-tx [options] -create [commands]   " + _("Create hex-encoded denizlite transaction") + "\n" +
              "\n";
