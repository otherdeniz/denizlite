...
#if defined(NDEBUG)
# error "Denizlite cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Denizlite Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s DNL additional fees, %d delta bytes\n",
