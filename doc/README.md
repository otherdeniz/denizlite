...
To download Litecoin Core, visit [denizlite.org](https://denizlite.org).
...
* See the documentation at the [Litecoin Wiki](https://denizlite.info/)
...
* Ask for help on the [LitecoinTalk](https://denizlitetalk.io/) forums.
...
### Resources
* Discuss on the [LitecoinTalk](https://denizlitetalk.io/) forums.
* Discuss general Litecoin development on #denizlite-dev on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=denizlite-dev).
